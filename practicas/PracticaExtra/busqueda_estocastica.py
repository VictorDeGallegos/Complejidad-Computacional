...
if __name__ == "__main__":
    ...
    print('Número de cláusulas:', instancia['clausulas'])
    print('Número de variables:', instancia['variables'])
    print('Número de cláusulas que se satisfacen:',
          mejor_solucion['evaluacion'])
    print('Asignación de verdad:', mejor_solucion['asignacion'])
